...
function convertPdfToJpg(file) {
    return fetch('https://v2.convertapi.com/convert/pdf/to/jpg?Secret=xaN9DxHZFfVXhEqQ&download=attachment', {
        method: 'POST',
        body: file,
    });
}
...
function convertPdfToPng(file) {
    return fetch('https://v2.convertapi.com/convert/pdf/to/png?Secret=xaN9DxHZFfVXhEqQ&download=attachment', {
        method: 'POST',
        body: file,
    });
}
...
function convertJpgToPng(file) {
    return fetch('https://v2.convertapi.com/convert/jpg/to/png?Secret=xaN9DxHZFfVXhEqQ&download=attachment', {
        method: 'POST',
        body: file,
    });
}
...
function convertPngToJpg(file) {
    return fetch('https://v2.convertapi.com/convert/png/to/jpg?Secret=xaN9DxHZFfVXhEqQ&download=attachment', {
        method: 'POST',
        body: file,
    });
}
...
function convertPngToPdf(file) {
    return fetch('https://v2.convertapi.com/convert/png/to/pdf?Secret=xaN9DxHZFfVXhEqQ&download=attachment', {
        method: 'POST',
        body: file,
    });
}
...
function convertJpgToPdf(file) {
    return fetch('https://v2.convertapi.com/convert/jpg/to/pdf?Secret=xaN9DxHZFfVXhEqQ&download=attachment', {
        method: 'POST',
        body: file,
    });
}
...
function convertWordToPdf(file) {
    return fetch('https://v2.convertapi.com/convert/docx/to/pdf?Secret=xaN9DxHZFfVXhEqQ&download=attachment', {
        method: 'POST',
        body: file,
    });
}
function convertPdfToWord(file) {
    return fetch('https://v2.convertapi.com/convert/pdf/to/txt?Secret=xaN9DxHZFfVXhEqQ&download=attachment', {
        method: 'POST',
        body: file,
    });
}
